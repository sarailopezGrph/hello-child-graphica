...
(function($) {
	$(document).ready(function() {
		...
		$('.elementor-field-type-upload .elementor-field-label').html('<div class="input"><strong>Sube un archivo</strong></div><span>Seleccionar</span>');
		...
		// Validación solo Alfabética: Clase .input-alfa
		$('.input-alfa').bind('keyup blur',function(){
				let node = $(this);
		...
		// Validación solo Numérico: Clase .input-numero
		$('.input-numero').bind('keyup blur',function(){
				let node = $(this);
		...
		// Validación correo electrónico: Clase .input-email
